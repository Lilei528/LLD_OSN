...
class get_f1():
    def __init__(self):
        self.true_list=[]
        self.pre_list=[]
    def add_some_result(self,true_list,pre_list):


        self.true_list.extend(true_list)
        self.pre_list.extend(pre_list)
    def reset(self):
        self.true_list=[]
        self.pre_list=[]

    def cal_f1_score(self):
        labels_f1=f1_score(self.true_list,self.pre_list,average=None)
        avg_f1=f1_score(self.true_list,self.pre_list,average='macro')

        return {'avg':avg_f1,'all':labels_f1}
